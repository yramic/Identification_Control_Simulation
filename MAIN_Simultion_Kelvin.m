...
%% FIND SPECIFIC POINT FOR LINEARIZATION WHILE DOOR OPEN:
...
dxdt_o(5) = a9*(x(1)-x(5)) + a10*(x(3)-x(5)) + a11*(x(5)-x(4)) + ...
    xi*(T_atm-x(5));
dxdt_o(6) = (c2_v * x1_stat) * x(6) + (-c1_v / T_atm)* x(5) + ...
