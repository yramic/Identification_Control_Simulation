...
dxdt_comparison(1) = f_1(1)*f_2(1)*th*(x(2)-x(1)) - ...
    f_1(2)*f_2(2)*th*(x(1)-x(5));
dxdt_comparison(2) = f_1(3)*f_2(3)*th*(T_atm-x(2)) - ...
    f_1(4)*f_2(4)*th*(x(2)-x(1));
dxdt_comparison(3) = 0;
dxdt_comparison(4) = (f_1(5)*f_2(5)*s_Fan + ...
    (1-s_Fan)*f_1(6)*f_2(6)) * ...
    th*(x(5)-x(4)) - ... 
    f_1(7)*f_2(7)*th*I*x(4) + ...
    f_1(8)*f_2(8)*th*(I^2) + ...
    f_1(9)*f_2(9)*th*(T_water-x(4));
dxdt_comparison(5) = f_1(10)*f_2(10)*th*(x(1)-x(5)) - ...
    (f_1(11)*f_2(11)*s_Fan + ...
    (1-s_Fan)*f_1(12)*f_2(12)) * ...
    th*(x(5)-x(4)) + ...
    f_1(13)*f_2(13)*th*(T_atm-x(5))*s_Door + ...
    f_1(14)*f_2(14)*th*s_Fan;
...
%All 6 Differential Equations
dxdt(1) = th_1(1)*f_1(1)*(x(2)-x(1)) - ...
    th_1(2)*f_1(2)*(x(1)-x(5));
dxdt(2) = th_1(3)*f_1(3)*(T_atm-x(2)) - ...
    th_1(4)*f_1(4)*(x(2)-x(1));
dxdt(3) = 0; % -a5*(x(3)-x(5))*s_cargo;
dxdt(4) = (th_1(5)*f_1(5)*s_Fan + ...
    (1-s_Fan)*th_1(6)*f_1(6)) * ...
    (x(5)-x(4)) - ...
    th_1(7)*f_1(7)*I*x(4) + ...
    th_1(8)*f_1(8)*(I^2) + ...
    th_1(9)*f_1(9)*(T_water-x(4));
dxdt(5) = th_1(10)*f_1(10)*(x(1)-x(5)) - ...
    (th_1(11)*f_1(11)*s_Fan + ...
    (1-s_Fan)*th_1(12)*f_1(12)) * ...
    (x(5)-x(4)) + ...
    th_1(13)*f_1(13)*(T_atm-x(5))*s_Door + ...
    th_1(14)*f_1(14)*s_Fan;
