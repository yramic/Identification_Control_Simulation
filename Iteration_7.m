...
addpath('Iterations_7_14par');
Data_18 = importdata('Experiment_18_OLD.mat');
theta_1 = importdata('theta_1_boundary.mat'); 
theta_2 = importdata('theta_2_boundary.mat'); 
theta_3 = importdata('theta_3_boundary.mat'); 
theta_4 = importdata('theta_4_boundary.mat'); 
theta_5 = importdata('theta_5_boundary.mat'); 
theta_6 = importdata('theta_6_boundary.mat'); 
par.theta_1 = theta_1;
par.theta_2 = theta_2;
par.theta_3 = theta_3;
par.theta_4 = theta_4;
...
% Aufbau Data_18:
% 1.Spalte: Time t
% 2.Spalte: T_ICB_actual
% 3.Spalte: T_HS_actual
% 4.Spalte: T_w_i_actual
% 5.Spalte: I_actual
...
Parameters(4) = par.a4;
Parameters(5) = par.a6;
Parameters(6) = par.a_frei_1;
Parameters(7) = par.a7;
Parameters(8) = par.b2;
Parameters(9) = par.a8;
Parameters(10) = par.a9;
Parameters(11) = par.a11;
Parameters(12) = par.a_frei_2;
Parameters(13) = par.xi;
Parameters(14) = par.b3;
...
f_1 = [];
f_1 = Parameters./Theta_0_float;

for i = 1:numel(Parameters)
    Theta_0(i) = Theta_0_float;
end
Theta_0 = Theta_0';
...
x0_x1 = Data_18(1,4) + 273.15;
x0_x2 = 20 + 273.15; 
x0_x3 = 20 + 273.15;
x0_x4 = Data_18(1,3) + 273.15;
x0_x5 = Data_18(1,2) + 273.15;
...
% min_y_HS = 0;
% 
% if round(min(Data_18(:,3),[],'all'),0) < round(min(sim(:,4),[],'all'),0)
%     min_y_HS = round(min(Data_18(:,3),[],'all')-1,0);
% else
%     min_y_HS = round(min(sim(:,4),[],'all')-1,0);
% 
...
dxdt_comparison(1) = f_1(1)*f_2(1)*f_3(1)*f_4(1)*f_5(1)*f_6(1)*f_7(1)*th*(x(2)-x(1)) - ...
    f_1(2)*f_2(2)*f_3(2)*f_4(2)*f_5(2)*f_6(2)*f_7(2)*th*(x(1)-x(5));
dxdt_comparison(2) = f_1(3)*f_2(3)*f_3(3)*f_4(3)*f_5(3)*f_6(3)*f_7(3)*th*(T_atm-x(2)) - ...
    f_1(4)*f_2(4)*f_3(4)*f_4(4)*f_5(4)*f_6(4)*f_7(4)*th*(x(2)-x(1));
dxdt_comparison(3) = 0;
dxdt_comparison(4) = (f_1(5)*f_2(5)*f_3(5)*f_4(5)*f_5(5)*f_6(5)*f_7(5)*s_Fan + ...
    (1-s_Fan)*f_1(6)*f_2(6)*f_3(6)*f_4(6)*f_5(6)*f_6(6)*f_7(6)) * ...
    th*(x(5)-x(4)) - ... 
    f_1(7)*f_2(7)*f_3(7)*f_4(7)*f_5(7)*f_6(7)*f_7(7)*th*I*x(4) + ...
    f_1(8)*f_2(8)*f_3(8)*f_4(8)*f_5(8)*f_6(8)*f_7(8)*th*(I^2) + ...
    f_1(9)*f_2(9)*f_3(9)*f_4(9)*f_5(9)*f_6(9)*f_7(9)*th*(T_water-x(4));
dxdt_comparison(5) = f_1(10)*f_2(10)*f_3(10)*f_4(10)*f_5(10)*f_6(10)*f_7(10)*th*(x(1)-x(5)) - ...
    (f_1(11)*f_2(11)*f_3(11)*f_4(11)*f_5(11)*f_6(11)*f_7(11)*s_Fan + ...
    (1-s_Fan)*f_1(12)*f_2(12)*f_3(12)*f_4(12)*f_5(12)*f_6(12)*f_7(12)) * ...
    th*(x(5)-x(4)) + ...
    f_1(13)*f_2(13)*f_3(13)*f_4(13)*f_5(13)*f_6(13)*f_7(13)*th*(T_atm-x(5))*s_Door + ...
    f_1(14)*f_2(14)*f_3(14)*f_4(14)*f_5(14)*f_6(14)*f_7(14)*th*s_Fan;
...
%All 6 Differential Equations
dxdt(1) = th_6(1)*f_1(1)*f_2(1)*f_3(1)*f_4(1)*f_5(1)*f_6(1)*(x(2)-x(1)) - ...
    th_6(2)*f_1(2)*f_2(2)*f_3(2)*f_4(2)*f_5(2)*f_6(2)*(x(1)-x(5));
dxdt(2) = th_6(3)*f_1(3)*f_2(3)*f_3(3)*f_4(3)*f_5(3)*f_6(3)*(T_atm-x(2)) - ...
    th_6(4)*f_1(4)*f_2(4)*f_3(4)*f_4(4)*f_5(4)*f_6(4)*(x(2)-x(1));
dxdt(3) = 0; % -a5*(x(3)-x(5))*s_cargo;
dxdt(4) = (th_6(5)*f_1(5)*f_2(5)*f_3(5)*f_4(5)*f_5(5)*f_6(5)*s_Fan + ...
    (1-s_Fan)*th_6(6)*f_1(6)*f_2(6)*f_3(6)*f_4(6)*f_6(6)*f_5(6)) * ...
    (x(5)-x(4)) - ...
    th_6(7)*f_1(7)*f_2(7)*f_3(7)*f_4(7)*f_5(7)*f_6(7)*I*x(4) + ...
    th_6(8)*f_1(8)*f_2(8)*f_3(8)*f_4(8)*f_5(8)*f_6(8)*(I^2) + ...
    th_6(9)*f_1(9)*f_2(9)*f_3(9)*f_4(9)*f_5(9)*f_6(9)*(T_water-x(4));
dxdt(5) = th_6(10)*f_1(10)*f_2(10)*f_3(10)*f_4(10)*f_5(10)*f_6(10)*(x(1)-x(5)) - ...
    (th_6(11)*f_1(11)*f_3(11)*f_2(11)*f_4(11)*f_5(11)*f_6(11)*s_Fan + ...
    (1-s_Fan)*th_6(12)*f_1(12)*f_2(12)*f_3(12)*f_4(12)*f_5(12)*f_6(12)) * ...
    (x(5)-x(4)) + ...
    th_6(13)*f_1(13)*f_2(13)*f_3(13)*f_4(13)*f_5(13)*f_6(13)*(T_atm-x(5))*s_Door + ...
    th_6(14)*f_1(14)*f_2(14)*f_3(14)*f_4(14)*f_5(14)*f_6(14)*s_Fan;
