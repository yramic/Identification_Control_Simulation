...
load('theta_14par_500it_weighted.mat');
% theta_vektor = theta_opt;
load('f_1_14par.mat')
% load('f_2_opt.mat')
% load('f_3_opt.mat')
% load('f_4_opt.mat')
...
dxdt(1) = th(1)*f_1(1)*(x(2)-x(1)) ...
    -th(2)*f_1(2)*(x(1)-x(5));
dxdt(2) = th(3)*f_1(3)*(T_amb-x(2)) ...
    - th(4)*f_1(4)*(x(2)-x(1));
dxdt(3) = 0;
dxdt(4) = (th(5)*f_1(5)*s_Fan + ...
    (1-s_Fan)*th(6)*f_1(6))*(x(5)-x(4)) -...
    th(7)*f_1(7)*I*x(4) + ...
    th(8)*f_1(8)*(I^2) +...
    th(9)*f_1(9)*(T_water-x(4));
dxdt(5) = th(10)*f_1(10)*(x(1)-x(5)) - ...
    (th(11)*f_1(11)*s_Fan + ...
    (1-s_Fan)*th(12)*f_1(12))*(x(5)-x(4)) + ...
    th(13)*f_1(13)*(T_amb-x(5))*s_Door +...
    th(14)*f_1(14)*s_Fan;

% dxdt(1) = th(1)*(x(2)-x(1)) ...
%     -th(2)*(x(1)-x(5));
% dxdt(2) = th(3)*(T_amb-x(2)) ...
%     - th(4)*(x(2)-x(1));
% dxdt(3) = 0;
% dxdt(4) = (th(5)*s_Fan + ...
%     (1-s_Fan)*th(6))*(x(5)-x(4)) -...
%     th(7)*I*x(4) + ...
%     th(8)*(I^2) +...
%     th(9)*(T_water-x(4));
% dxdt(5) = th(10)*(x(1)-x(5)) - ...
%     (th(11)*s_Fan + ...
%     (1-s_Fan)*th(12))*(x(5)-x(4)) + ...
%     th(13)*(T_amb-x(5))*s_Door +...
%     th(14)*s_Fan;

% dxdt(1) = th(1)*f_1(1)*f_2(1)*f_3(1)*f_4(1)*f_5(1)*f_6(1)*f_7(1)*(x(2)-x(1)) ...
%     -th(2)*f_1(2)*f_2(2)*f_3(2)*f_4(2)*f_5(2)*f_6(2)*f_7(2)*(x(1)-x(5));
% dxdt(2) = th(3)*f_1(3)*f_2(3)*f_3(3)*f_4(3)*f_5(3)*f_6(3)*f_7(3)*(T_amb-x(2)) ...
%     - th(4)*f_1(4)*f_2(4)*f_3(4)*f_4(4)*f_5(4)*f_6(4)*f_7(4)*(x(2)-x(1));
% dxdt(3) = 0;
% dxdt(4) = (th(5)*f_1(5)*f_2(5)*f_3(5)*f_4(5)*f_5(5)*f_6(5)*f_7(5)*s_Fan + ...
%     (1-s_Fan)*th(6)*f_1(6)*f_2(6)*f_3(6)*f_4(6)*f_5(6)*f_6(6)*f_7(6))*(x(5)-x(4)) -...
%     th(7)*f_1(7)*f_2(7)*f_3(7)*f_4(7)*f_5(7)*f_6(7)*f_7(7)*I*x(4) + ...
%     th(8)*f_1(8)*f_2(8)*f_3(8)*f_4(8)*f_5(8)*f_6(8)*f_7(8)*(I^2) +...
%     th(9)*f_1(9)*f_2(9)*f_3(9)*f_4(9)*f_5(9)*f_6(9)*f_7(9)*(T_water-x(4));
% dxdt(5) = th(10)*f_1(10)*f_2(10)*f_3(10)*f_4(10)*f_5(10)*f_6(10)*f_7(10)*(x(1)-x(5)) - ...
%     (th(11)*f_1(11)*f_2(11)*f_3(11)*f_4(11)*f_5(11)*f_6(11)*f_7(11)*s_Fan + ...
%     (1-s_Fan)*th(12)*f_1(12)*f_2(12)*f_3(12)*f_4(12)*f_5(12)*f_6(12)*f_7(12))*(x(5)-x(4)) + ...
%     th(13)*f_1(13)*f_2(13)*f_3(13)*f_4(13)*f_5(13)*f_6(13)*f_7(13)*(T_amb-x(5))*s_Door +...
%     th(14)*f_1(14)*f_2(14)*f_3(14)*f_4(14)*f_5(14)*f_6(14)*f_7(14)*s_Fan;
