...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Um die Urpsrungssimulation wiederherzustellen werden alte konstante Werte
% für T_amb als auch T_water angenommen. Da beide mit 20 Grad Celsius 
% angenommen wurden, kann nur ein zusätzliches c(3) eingeführt werden!
% c(3) = 20+273.15;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
parameters = {theta_1_0; theta_2_0; theta_3_0; theta_4_0; theta_5_0;...
    ...
    theta_12_0; theta_13_0; theta_14_0}; 
...
if length(size(measurement_ident)) == 4
    ...
    for zaehler3 = 1:num_exp_ident
        ...
        est = idnlgrey('Non_Linear_ICB_IDENT_14par', Order, parameters, InitialStates_comp);
...
sys = idnlgrey('Non_Linear_ICB_IDENT_14par', Order, parameters, InitialStates);
...
theta_std = [theta_1_std, theta_2_std, theta_3_std, theta_4_std, theta_5_std, ...
    ...
    theta_12_std, theta_13_std, theta_14_std];
...
theta_mean = [theta_1_mean, theta_2_mean, theta_3_mean, theta_4_mean, theta_5_mean, ...
    ...
    theta_11_mean, theta_12_mean, theta_13_mean, theta_14_mean];
...
% save('model_14_weighted_boundary.mat','model')
...
theta_vektor = [theta_1; theta_2; theta_3; theta_4; theta_5; theta_6; ...
    ...
    theta_14];
% 
% save('theta_14par_500it_weighted.mat','theta_vektor');
...
figure
errorbar((1:14),theta_mean,theta_std)
xlabel('Parameters')
ylabel('Errorbar')
xlim([1,14])
